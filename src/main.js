document.addEventListener("DOMContentLoaded", function() {
    ...
    groupPages.forEach(page => {
        const navItems = document.querySelectorAll(`#${page}-button-escolares, #${page}-button-iniciacion, #${page}-button-benjamin-alevin, #${page}-button-adultos-infantil-cadete, #${page}-button-adultos-1, #${page}-button-adultos-2, #${page}-button-womens, #${page}-button-esport-salut-familia`);
        const contentDivs = document.querySelectorAll(`#${page}-escolares, #${page}-iniciacion, #${page}-benjamin-alevin, #${page}-adultos-infantil-cadete, #${page}-adultos-1, #${page}-adultos-2, #${page}-womens, #${page}-esport-salut-familia`);
